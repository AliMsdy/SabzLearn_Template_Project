...
const articleListDetail = [
  { title: "جاوا اسکریپت", Icon: FaFolder },
  { title: "ارسال شده توسط قدیر", Icon: FaUser },
  { title: "ارسال شده توسط قدیر", Icon: FaClock },
  { title: "2.14k بازدید", Icon: FaEye },
];
const headingList = [
        ...
        <div className="col-span-12 lg:col-span-8">
          ...
          <div className="blog-content rounded-lg p-6 px-6 shadow-custom dark:bg-dark-theme-secondary dark:shadow-dark-theme sm:px-8">
            ...
            <p>
              ...
              گسترده‌تری را انجام دهید. در حال حاضر با وجود منابع رایگان موجود
              در وب شما به راحتی می‌توانید زبان جاوا اسکریپت را به صورت حرفه‌ای
              فرا بگیرید. به همین واسطه در ادامه مطلب قصد داریم سایت‌های شاخص
              آموزش این زبان برنامه‌نویسی در جهان را به شما معرفی کنیم و در آخر
            ...
            <img src="/src/assets/images/blog/4.png" alt="" />
            <h2>معرفی بهترین سایت ‌های آموزش جاوا اسکریپت:</h2>
            <p>
              توجه داشته باشید که تمام وب سایت‌هایی که به عنوان بهترین سایت
              آموزش جاوا اسکریپت در ادامه معرفی می‌کنیم، بین‌المللی هستند و
          ...
          <div className="mt-12 flex gap-x-8 rounded-lg bg- p-4 dark:bg-dark-theme-secondary sm:p-6">
