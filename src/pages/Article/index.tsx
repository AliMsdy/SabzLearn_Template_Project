...
//api
import { useArticleInfo } from "@/services/query";
          ...
          <div className="col-span-12 lg:col-span-8">
            ...
            <div className="blog-content rounded-lg p-6 px-6 shadow-custom dark:bg-dark-theme-secondary dark:shadow-dark-theme sm:px-8">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-4 text-[0.8rem]">
                <ArticleDetail Icon={FaFolder} title={`دسته بندی: ${data.categoryID.title}`} />
                <ArticleDetail Icon={FaUser} title={`ارسال شده توسط: ${data.creator.name}`} />
                <ArticleDetail
                  Icon={FaClock}
